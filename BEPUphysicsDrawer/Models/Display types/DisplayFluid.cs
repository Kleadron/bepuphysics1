...
namespace BEPUphysicsDrawer.Models
{
    ...
    public class DisplayFluid : ModelDisplayObject<FluidVolume>
    {
        ...
        public override void GetMeshData(List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            {
                Vector3 upVector = DisplayedObject.UpVector;
                vertices.Add(new VertexPositionNormalTexture(DisplayedObject.SurfaceTriangles[i][0], upVector, new Vector2(0, 0)));
                vertices.Add(new VertexPositionNormalTexture(DisplayedObject.SurfaceTriangles[i][1], upVector, new Vector2(0, 1)));
                vertices.Add(new VertexPositionNormalTexture(DisplayedObject.SurfaceTriangles[i][2], upVector, new Vector2(1, 0)));
